...
## AI-Generated Branch Notice

This branch was generated by OpenAI Codex (GPT-5.5, xhigh). Stability is not
guaranteed. Treat it as an AI-produced rebuild branch that needs human review,
independent testing, and legal review before production or App Store use.
...
AI-assisted rebuild work on this branch was generated by OpenAI Codex
(GPT-5.5, xhigh).
