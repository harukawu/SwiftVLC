...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "libvlc",
      url: "https://github.com/harukawu/SwiftVLC/releases/download/v0.10.4/libvlc.xcframework.zip",
      checksum: "8e464b850fcce2c3175e3839985fbfadb24f54ae1ca0ea47bf4376121e175f3c"
    ),
    .target(
      name: "CLibVLC",
      dependencies: ["libvlc"],
