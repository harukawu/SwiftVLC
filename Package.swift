...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "libvlc",
      url: "https://github.com/harukawu/SwiftVLC/releases/download/v0.10.0/libvlc.xcframework.zip",
      checksum: "b95c6c0978334ed0a24e08c4010b139e15f657add6c3e1c0ea72e209d0a708cf"
    ),
    .target(
      name: "CLibVLC",
      dependencies: ["libvlc"],
