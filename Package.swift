...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "libvlc",
      url: "https://github.com/harukawu/SwiftVLC/releases/download/v0.9.0/libvlc.xcframework.zip",
      checksum: "36aa38af07a9576fb2890a5fe50a417dac9e13ff5a3f97f85cd2973cc38c528a"
    ),
    .target(
      name: "CLibVLC",
      dependencies: ["libvlc"],
